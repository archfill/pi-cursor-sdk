...
- `pi --version` reports Pi 0.84.3 for this cutover baseline.
- `npm ls` shows `@cursor/sdk@1.0.27` and local `@earendil-works/*@0.84.3` packages.
...
- The run uses Pi 0.84.3 `--session-id` successfully.
