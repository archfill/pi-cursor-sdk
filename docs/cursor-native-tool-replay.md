...
For the full `@cursor/sdk@1.0.31` `ToolType` set, disposition matrix, and runtime alias normalization, see [SDK ToolType replay matrix](#sdk-tooltype-replay-matrix) below. Official SDK reference: https://cursor.com/docs/sdk/typescript
...
Source of truth for SDK tool names: `@cursor/sdk@1.0.31` conversation `ToolType` values and https://cursor.com/docs/sdk/typescript
