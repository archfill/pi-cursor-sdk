...
const fixture = JSON.parse(
	readFileSync(new URL("./fixtures/cursor-sdk-retriable-stalled-1.0.31.json", import.meta.url), "utf8"),
) as RetriableStalledContractFixture;

describe("installed Cursor SDK RetriableError connection-stalled contract", () => {
	it("matches installed @cursor/sdk 1.0.31 source markers and classifier shape", () => {
